@php
    ...
    $bnacion_logo = app_path('CoreFacturalo'.DIRECTORY_SEPARATOR.'Templates'.DIRECTORY_SEPARATOR.'pdf'.DIRECTORY_SEPARATOR.'default_exito'.DIRECTORY_SEPARATOR.'bnacion_logo');
